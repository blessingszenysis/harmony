...
# URLs from https://opendatasus.saude.gov.br/dataset/sistema-de-informacao-sobre-nascidos-vivos-sinasc-1996-a-2020
def get_url(year: int) -> str:
    return f'https://diaad.s3.sa-east-1.amazonaws.com/sinasc/SINASC_{year}.csv'
...
def main():
    ...
    while current_year <= end_year:
        ...
        output_file_name = os.path.join(output_folder, f'sinasc_{current_year}.csv.lz4')
